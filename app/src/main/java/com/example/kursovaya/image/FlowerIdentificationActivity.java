...
public class FlowerIdentificationActivity extends ImageClassificationActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomImageLabelerOptions options = new CustomImageLabelerOptions.Builder(localModel).setConfidenceThreshold(0.7f).setMaxResultCount(5).build();
        ...
        imageLabeler.process(inputImage).addOnSuccessListener(new OnSuccessListener<List<ImageLabel>>() {
            ...
            public void onSuccess(List<ImageLabel> imageLabels) {
                if (imageLabels.size() > 0){
                    ...
                    getOutputTextView().setText("failed");
                }
            }
